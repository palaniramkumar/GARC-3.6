...
<div style="background-color:White;padding:10px;">
   ...
   <FORM id="form1" METHOD="POST" ENCTYPE="multipart/form-data" ACTION="./AjaxPages/AddTopic.jsp">
    ...
    <textarea name="topic_text" id="topic_text" rows=8 cols=90 wrap=virtual></textarea>
