...
<%
        if(request.getParameter("title")!=null){
            ...
            statement.executeUpdate("insert into mail values(null,'"+session.getAttribute("userid")+"','Forum["+request.getParameter("title")+"]','1','"+request.getParameter("desc")+"',now(),'','UNREAD')");
    ...
    <form method=get action='#'>
        ...
        <textarea name="desc" id="desc" rows=8 cols=90 wrap=virtual></textarea></p>
