...
if(request.getParameter("student_name")!=null){
    try{
        ...
        String sql="insert into students(student_id,pass,student_name,semester,section,batch,username) values('"+request.getParameter("student_id")+"', password('"+request.getParameter("student_id")+"'),'"+request.getParameter("student_name")+"',"+request.getParameter("semester")+","+(request.getParameter("section").trim().charAt(0)-'A'+1)+","+request.getParameter("batch")+",'"+request.getParameter("student_id")+"');";
        //out.print(sql);
