  ...
  --%>
<%-- 
    Document   : GQuestAddQuestion
    Created on : Jun 5, 2010, 8:23:57 PM
    Author     : Ram
--%>
...
$("#data").html("<center><img src='/images/preload.gif'/> Loading please wait ...</center>");
loadTemplate();
 });
		...
		encodedHtml = encodedHtml.replace(/\>/g,"%3E");
            ...
            function add(val){
                ...
                var cat=encodeMyHtml(document.getElementById("category").value);
                var wt=document.getElementById("weight").value;
                var choice="";
                    //=encodeMyHtml(document.getElementById("c1").value)+"#"+encodeMyHtml(document.getElementById("c2").value)
                      //     +"#"+encodeMyHtml(document.getElementById("c3").value)+"#"+encodeMyHtml(document.getElementById("c4").value)
                        //   +"#"+encodeMyHtml(document.getElementById("c5").value)
                for (var i = 1; i <=5;i++){
                        ...
                        $.ajax({
                            ...
                            success: function(msg){
                                ...
                                if(val!=0){
                                 ...
                                 if(val==0 && msg.indexOf("successfully")!=-1){
            ...
            function clearEditor(){
                ...
                for (var i = 1; i <=5;i++){
                        nicEditors.findEditor('c'+i).setContent("");
                }
            }
