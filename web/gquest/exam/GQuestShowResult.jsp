  ...
  --%>
<%--
    Document   : GQuestShowResult
    Created on : Jun 5, 2010, 11:31:22 PM
    Author     : Ram
--%>
...
$("#content").html("<center><img src='/images/preload.gif'/> Loading please wait ...</center>");
                var exam_id="<%=request.getParameter("exam_id")%>";
                 url="rand="+Math.random()+"&exam_id="+exam_id
                 $.ajax({
                            type: "POST",
                            url: "singleexamsummeryAjax.jsp",
                            data: url,
...
<div id="content">
  ...
  <table width="520" border="0">
    <tr>
      <th height="58" valign="middle"  scope="col"><h3 align="left"></h3></th> <!--// H1 title -->
    </tr>
    <tr>
      <td >
      <div id="data"></div>
